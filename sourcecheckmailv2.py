...
def fakeEmail():
  ...
  for fake in range(so_luong):
    ...
    print (" [" + str(n) + "] ➻❥ |X-Tools|" + fake_email)
...
def checkhotmail():
  ...
  def run_check_hotmail(hot_mail):
    ...
    if kq == None:
      print (" \033[1;31m➻❥ |\033[1;37mX-Tools\033[1;31m|Email Live|" + hot_mail)
    else:
      print (" \033[1;32m➻❥ |\033[1;37mX-Tools\033[1;32m|Email Die|" + hot_mail)
...
def checkyahoo():
  ...
  def run_check_yahoo(yid):
    ...
    if KQ == None:
      print(" \033[1;32m➻❥ |\033[1;37mX-Tools\033[1;32m|Email Die| " + yid + "@yahoo.com")
      open(yahoo_die,"a").write(yid + "@yahoo.com" + "\n")
    else:
      print(" \033[1;31m➻❥ |\033[1;37mX-Tools\033[1;31m|Email Live| " + yid + "@yahoo.com")
  with concurrent.futures.ThreadPoolExecutor() as executor:
  ...
  def run_check_valid(emailfb):
    ...
    if valid_fb == None:
      ...
      if kq_check_code == None:
        print (" \033[1;32m➻❥ |\033[1;37mX-Tools\033[1;32m|Có Liên Kết|Code 8|" + emailfb)
        open(valid,"a").write("|code 8|" + emailfb + "\n")
      else:
        print (" \033[1;32m➻❥ |\033[1;37mX-Tools\033[1;32m|Có Liên Kết|Code 6|" + emailfb)
        open(valid,"a").write("|code 6|" + emailfb + "\n")
    else:
      print (" \033[1;31m➻❥ |\033[1;37mX-Tools\033[1;31m| Không Liên Kết |" + emailfb)
  with concurrent.futures.ThreadPoolExecutor() as executor:
...
def logo():
  logo = """
        ...
        \033[1;36m░░▀░░ ▀▀▀▀ ▀▀▀▀ ▀▀▀   \033[1;34m▀▀▀ ▀░░▀ ▀▀▀ ▀▀▀ ▀░░▀   \033[1;35m▀░░░▀ ▀░░▀ ▀▀▀ ▀▀▀
                  \033[0;33m➻❥ Copyright By : Lâm Gia Huy
                  \033[1;34m➻❥ Zalo : 0942397476
                  \033[1;32m➻❥ Facebook : https://facebook.com/100049749402484
"""
